...
final class q5FinalHandler implements HttpHandler{
	...
	public q5FinalHandler(HConnection connection) throws IOException,FileNotFoundException{
		...
		System.out.println("Build Q5 Cache start");
		...
		scan.close();
		//System.gc();
		System.out.println("Build Q5 cache success");
	...
	public void handleRequest(HttpServerExchange exchange)throws Exception{
      ...
      //System.out.println("n:" + nValue);
			...
			String win1 = "",win2 = "",win3 = "",winAll = "";
			if(Integer.valueOf(m1) > Integer.valueOf(n1))
				win1 = mValue;
			else if(Integer.valueOf(m1) == Integer.valueOf(n1))
				win1 = "X";
			else
				win1 = nValue;

			if(Integer.valueOf(m2) > Integer.valueOf(n2))
				win2 = mValue;
			else if(Integer.valueOf(m2) == Integer.valueOf(n2))
				win2 = "X";
			else
				win2 = nValue;

			if(Integer.valueOf(m3) > Integer.valueOf(n3))
				win3 = mValue;
			else if(Integer.valueOf(m3) == Integer.valueOf(n3))
				win3 = "X";
			else
				win3 = nValue;

			if(Integer.valueOf(mAll) > Integer.valueOf(nAll))
				winAll = mValue;
			else if(Integer.valueOf(mAll) == Integer.valueOf(nAll))
				winAll = "X";
			else
				winAll = nValue;
